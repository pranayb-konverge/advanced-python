...
# CRUD Dictionary
# get the 'name' value
name_in_dict = my_dict_2["name"]
print(name_in_dict)

# add/update the key values 
print(my_dict_2)
my_dict_2["age"] = 25
my_dict_2["email"] = "something123@somthind.com"
print(my_dict_2)
...
print("popped value:", my_dict_2.pop("age"))
...
tuple11 = (("string_key1", 23), ("string_key2", 33))
tuple_dict = dict(tuple11)
